...
//                countSubstrings("input/substrings_in1.txt", listOf("Карминовый", "Некрасивый", "белоглазый")))
        assertEquals(mapOf("абвбабвааавмб" to 8, "ахюбОббЦв" to 6, "рвЕювбыбЛКУбЪб" to 5, "авба" to 7),
                countSubstrings("input/substrings_in2.txt", listOf("абвбабвааавмб", "ахюбОббЦв", "рвЕювбыбЛКУбЪб", "авба")))
    }
